                ...
                switch (_type) {
                    ...
                    case 'diamond':
                            if (global.db.data.users[m.sender].money >= Bdiamond * count) {
                                ...
                                conn.reply(m.chat, `Sukses Membeli ${count} Diamond Dengan Harga Rp.${Bdiamond * count}`, m)
                    ...
                    case 'common':
                            if (global.db.data.users[m.sender].money >= Bcommon * count) {
                                ...
                                conn.reply(m.chat, `Sukses Membeli ${count} Common Dengan Harga Rp.${Bcommon * count}`, m)
                            } else conn.reply(m.chat, `Uang Tidak Cukup`, m)
                    ...
                    case 'uncommon':
                            if (global.db.data.users[m.sender].money >= Buncommon * count) {
                                ...
                                conn.reply(m.chat, `Sukses Membeli ${count} Uncommon Dengan Harga Rp.${Buncommon * count}`, m)
                            } else conn.reply(m.chat, `Uang Tidak Cukup`, m)
                    ...
                    case 'mythic':
                            if (global.db.data.users[m.sender].money >= Bmythic * count) {
                                ...
                                conn.reply(m.chat, `Sukses Membeli ${count} Mythic Dengan Harga Rp.${Bmythic * count}`, m)
                            } else conn.reply(m.chat, `Uang Tidak Cukup`, m)
                    ...
                    case 'legendary':
                            if (global.db.data.users[m.sender].money >= Blegendary * count) {
                                ...
                                conn.reply(m.chat, `Sukses Membeli ${count} Legendary Dengan Harga Rp.${Blegendary * count}`, m)
                            } else conn.reply(m.chat, `Uang Tidak Cukup`, m)
                    ...
                    case 'sampah':
                            if (global.db.data.users[m.sender].money >= Bsampah * count) {
                                ...
                                conn.reply(m.chat, `Sukses Membeli ${count} Sampah Dengan Harga Rp.${Bsampah * count}`, m)
                    ...
                    case 'kaleng':
                            if (global.db.data.users[m.sender].money >= Bkaleng * count) {
                                ...
                                conn.reply(m.chat, `Sukses Membeli ${count} Kaleng Dengan Harga Rp.${Bkaleng * count}`, m)
                            } else conn.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'kardus':
                            if (global.db.data.users[m.sender].money >= Bkardus * count) {
                                ...
                                conn.reply(m.chat, `Sukses Membeli ${count} Kardus Dengan Harga Rp.${Bkardus * count}`, m)
                            } else conn.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'botol':
                            if (global.db.data.users[m.sender].money >= Bbotol * count) {
                                ...
                                conn.reply(m.chat, `Sukses Membeli ${count} Botol Dengan Harga Rp.${Bbotol * count}`, m)
                            } else conn.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'kayu':
                            if (global.db.data.users[m.sender].money >= Bkayu * count) {
                                ...
                                conn.reply(m.chat, `Sukses Membeli ${count} Kayu Dengan Harga Rp.${Bkayu * count}`, m)
                            } else conn.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
                    ...
                    case 'pisang':
                            if (global.db.data.users[m.sender].money >= Bpisang * count) {
                                ...
                                conn.reply(m.chat, `Sukses Membeli ${count} Pisang Dengan Harga Rp.${Bpisang * count}`, m)
                            } else conn.reply(m.chat, `Uang Tidak Cukup`.trim(), m)
